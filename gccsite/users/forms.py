...
class UserProfileForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['gender'].choices = [
            (
                Gender.female.value,
                mark_safe(_("<em>She is writing code for the contest</em>")),
            ),
            (
                Gender.male.value,
                mark_safe(_("<em>He is writing code for the contest</em>")),
            ),
...
class PasswordResetForm(forms.Form):
    email = forms.EmailField(
        ...
        widget=forms.EmailInput(
            attrs={'placeholder': _("Your email address")}
        ),
    )
...
class AuthenticationForm(DjangoAuthenticationForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['username'].help_text = _(
            "This field is case insensitive. It means capitals and small letters are "
...
class ConfirmDeleteUserForm(ConfirmDangerMixin, forms.ModelForm):
    username_conf = forms.CharField(
        ...
        help_text=_(
            "Type your username to confirm you know what you are doing."
        ),
    )
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['username_conf'].widget.attrs[
            'placeholder'
        ...
        self.fields['password_conf'].widget.attrs[
            'autocomplete'
        ] = 'new-password'
